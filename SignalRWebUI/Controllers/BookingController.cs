...
namespace SignalRWebUI.Controllers
{
    public class BookingController : Controller
    {
        ...
        {
			var client = _httpClientFactory.CreateClient();
			await client.GetAsync($"https://localhost:7180/api/Booking/BookingStatusApproved/{id}");
            return RedirectToAction("Index");
		}
		...
		{
			var client = _httpClientFactory.CreateClient();
			await client.GetAsync($"https://localhost:7180/api/Booking/BookingStatusCancelled/{id}");
			return RedirectToAction("Index");
		}
	}
}
